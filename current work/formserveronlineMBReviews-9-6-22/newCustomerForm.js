...
function GetUrl(par1) {
  ...
  const camps = [
    { "Aiais": "Ai Ais - Fish River Canyon" },
    { "Boplaas": "Boplaas" },
    { "DaanViljoen": "Daan Viljoen" },
    { "DeadValleyLodge": "Dead Valley Lodge" },
    { "Dolomite": "Dolomite - Etosha" },
    { "Duwisib": "Duwisib Castle - Closed" },
    { "GrossBarmen": "Gross Barmen - Okahandja" },
    { "Halali": "Halali - Etosha" },
    { "HardapResort": "Hardap Resort" },
    ...
    { "PopaFalls": "Popa Falls Camp" },
    { "SharkIsland": "Shark Island - Luderitz" },
    { "Sesriem": "Sesriem - Namib Desert" },
    { "SesriemOshana": "Sesriem Oshana" },
    { "SossusDune": "Sossus Dune Lodge - Namib Desert" },
    { "TerraceBay": "Terrace Bay - Skeleton Coast" },
    { "TorraBay": "Torra Bay - Skeleton Coast" },
    { "Waterberg": "Waterberg Camp" },
    { "Windpomp14": "Windpomp 14" },
  ];
